...
void displayTestingProgress(int imgCount, int errCount, int errCount_diff_arith, int y, int x){
    ...
    double accuracy_diff_arith = 1 - ((double)errCount_diff_arith/(double)(imgCount+1));
    
    printf("Result: Correct=%5d  Incorrect=%5d  Accuracy=%5.4f%% \n",imgCount+1-errCount_diff_arith, errCount_diff_arith, accuracy_diff_arith*100);
